...
<form method="post" class="edit-form">
  ...
  <div class="form-group row">
    ...
    <select class="col-6" name="level" id="level" selected="<?php echo escape($user["level"]); ?>">
...
<?php if (isset($_POST['update']) && $statement) : ?>
	<blockquote><?php echo escape($_POST['name']); ?> successfully updated. <?php echo escape($user["name"]); ?></blockquote>
<?php endif; ?>
